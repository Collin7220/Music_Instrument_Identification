...
class GenreFeatureData:
    ...
    dir_trainfolder = "./classifier/gtzan/_train"
    dir_devfolder = "./classifier/gtzan/_validation"
    dir_testfolder = "./classifier/gtzan/_test"
    dir_all_files = "./classifier/gtzan"

    train_X_preprocessed_data = "./classifier/gtzan/data_train_input.npy"
    train_Y_preprocessed_data = "./classifier/gtzan/data_train_target.npy"
    dev_X_preprocessed_data = "./classifier/gtzan/data_validation_input.npy"
    dev_Y_preprocessed_data = "./classifier/gtzan/data_validation_target.npy"
    test_X_preprocessed_data = "./classifier/gtzan/data_test_input.npy"
    test_Y_preprocessed_data = "./classifier/gtzan/data_test_target.npy"
